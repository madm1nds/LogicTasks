...
/// <summary>
/// Action when clicking on the second coin.
/// </summary>
public class Taskss4_2 : MonoBehaviour
{
#pragma warning disable CS0414
    ...
    static public bool isTail2 = false;
    bool lockCent = false;

    public void FlipCent2()
    {
        if (Taskss4_1.countFlip == 0)
        {
            Taskss4_1.pointerCent = 2;

            if (isTail2 == false)
            {
                cent2.GetComponent<Image>().sprite = tail;
                isTail2 = true;
            }
            else
            {
        ...
        if ((Taskss4_1.pointerCent == 1 || Taskss4_1.pointerCent == 3) && Taskss4_1.countFlip == 1 )
        {
            Taskss4_1.pointerCent2Step = 2;
            if (isTail2 == false)
            {
