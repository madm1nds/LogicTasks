...
/// <summary>
/// Action when clicking on the fifth coin.
/// </summary>
public class Taskss4_5 : MonoBehaviour
{
#pragma warning disable CS0414
    ...
    static public bool isTail5 = false;
    bool lockCent = false;

    public void FlipCent5()
    {
        if (Taskss4_1.countFlip == 0)
        {
            Taskss4_1.pointerCent = 5;

            if (isTail5 == false)
            {
                cent5.GetComponent<Image>().sprite = tail;
                isTail5 = true;
            }
            else
            {
        ...
        if (Taskss4_1.pointerCent == 4 && Taskss4_1.countFlip == 1)
        {
            Taskss4_1.pointerCent2Step = 5;
            if (isTail5 == false)
            {
                cent5.GetComponent<Image>().sprite = tail;
                isTail5 = true;
        ...
        if (Taskss4_1.pointerCent == 3 && Taskss4_1.pointerCent2Step == 4 && Taskss4_1.countFlip == 2)
        {
            if (isTail5 == false)
            {
                cent5.GetComponent<Image>().sprite = tail;
        ...
        if (Taskss4_1.pointerCent == 4 && Taskss4_1.pointerCent2Step == 3 && Taskss4_1.countFlip == 2)
        {
            if (isTail5 == false)
            {
                cent5.GetComponent<Image>().sprite = tail;
