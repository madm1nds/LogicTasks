...
/// <summary>
/// Action when clicking on the fourth coin.
/// </summary>
public class Taskss4_4 : MonoBehaviour
{
#pragma warning disable CS0414
    ...
    static public bool isTail4 = false;
    bool lockCent = false;
    
    public void FlipCent4()
    {
        if (Taskss4_1.countFlip == 0)
        {
            Taskss4_1.pointerCent = 4;

            if (isTail4 == false)
            {
                cent4.GetComponent<Image>().sprite = tail;
                isTail4 = true;
            }
            else
            {
        ...
        if ((Taskss4_1.pointerCent == 3 || Taskss4_1.pointerCent == 5) && Taskss4_1.countFlip == 1)
        {
            Taskss4_1.pointerCent2Step = 4;
            if (isTail4 == false)
            {
                cent4.GetComponent<Image>().sprite = tail;
                isTail4 = true;
